          ...
          <div style={{ height: 320 }}>
            <ResponsiveContainer width="100%" height="100%">
              {trendCategory === 'coverage' ? (
                <ComposedChart data={MONTHLY_TREND} margin={{ top: 4, right: 16, left: 0, bottom: 0 }}>
                  <CartesianGrid strokeDasharray="3 3" stroke="#F3F4F6" />
                  <XAxis dataKey="month" fontSize={11} tick={{ fill: '#9CA3AF' }} />
                  <YAxis fontSize={11} tick={{ fill: '#9CA3AF' }} />
                  <Tooltip content={<TrendTooltip order={['checkEnt', 'safeEnt', 'hazardEnt']} />} />
                  <Legend content={<TrendLegend order={['checkEnt', 'safeEnt', 'hazardEnt']} />} />
                  {/* recharts 真实浏览器：Bar 视觉顺序 = JSX 声明顺序左旋 1 位（headless 无偏移，实测以真实浏览器为准） */}
                ...
                <ComposedChart data={MONTHLY_TREND} margin={{ top: 4, right: 16, left: 0, bottom: 0 }}>
                  ...
                  <Tooltip content={<TrendTooltip order={['hazardTotal', 'hazardRectified', 'rectifyRate']} />} />
                  <Legend content={<TrendLegend order={['hazardTotal', 'hazardRectified', 'rectifyRate']} />} />
